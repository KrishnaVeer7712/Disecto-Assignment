...
print("================")
print("Now we will add or multiply a ciphered value of 4 to the encrypted value")
...
print("Result of Additive property:\t\t",mess2)

#cipher3= (k3 * k2) % (n*n)
MulCiplertotal= (cipher * cipher2)

Mul_l=(pow(ciphertotal, gLambda, n*n)-1)

mess3 = (Mul_l* gMu)*x+ m1*m

print("Result of multiplicative property:\t\t",mess3)
